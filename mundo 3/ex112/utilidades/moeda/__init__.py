...
def resumo(n=0, taxaup=0, taxadown=0):
    ...
    print(f'{'Dobro de ' + formato(n) + ':':<30}{formato(dobro(n)):>8}\n'
          ...
          f'{'Aumento de ' + formato_taxa(taxaup) + '%:':<30}{formato(aumentar(n, taxaup)):>8}\n'
          f'{'Diminuição de ' + formato_taxa(taxadown) + '%:':<30}{diminuir(n, taxadown, True):>8}')
    return ''
